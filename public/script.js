document.addEventListener('DOMContentLoaded', function() {
    ...
    if (animatedElements.length > 0) {
        ...
        style.textContent = '.fade-in.visible, [data-animate].visible { opacity: 1 !important; transform: translateY(0) !important; }';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f90b6ccd-9fe5-4844-96df-c2a8c9595646',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f90b6ccd-9fe5-4844-96df-c2a8c9595646';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f90b6ccd-9fe5-4844-96df-c2a8c9595646';
